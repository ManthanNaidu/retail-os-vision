...
export const STORE_TYPES: Record<string, StoreType> = {
  medical: {
    ...
    iconName: 'Pill',
    image: '/images/icons/store_medical.jpg',
  ...
  grocery: {
    ...
    image: '/images/icons/store_grocery.jpg',
  ...
  electronics: {
    ...
    iconName: 'Smartphone',
    image: '/images/icons/store_electronics.jpg',
  ...
  clothing: {
    ...
    iconName: 'Shirt',
    image: '/images/icons/store_clothing.jpg',
  ...
  hardware: {
    ...
    name: 'Hardware / Tools',
    iconName: 'Wrench',
    image: '/images/icons/store_hardware.jpg',
  ...
  bakery: {
    ...
    name: 'Bakery / Food',
    iconName: 'Coffee',
    image: '/images/icons/store_bakery.jpg',
  ...
  stationery: {
    ...
    iconName: 'BookOpen',
    image: '/images/icons/store_stationery.jpg',
  ...
  general: {
    ...
    name: 'General Store',
    iconName: 'Store',
    image: '/images/icons/store_general.jpg',
  ...
  wholesale: {
    ...
    iconName: 'Package',
    image: '/images/icons/store_wholesale.jpg',
