...
export const mockProducts: Product[] = [
  { id: 'p1', name: 'Tata Salt 1kg', sku: 'GRO001', barcode: '8901234567890', category: 'Grocery', brand: 'Tata', purchasePrice: 18, sellingPrice: 22, mrp: 24, stock: 45, minStock: 20, unit: 'Kg', gstPercent: 5, supplier: 'sup1', isActive: true, createdAt: '2024-01-01' },
  { id: 'p2', name: 'Aashirvaad Atta 5kg', sku: 'GRO002', barcode: '8901234567891', category: 'Grocery', brand: 'Aashirvaad', purchasePrice: 185, sellingPrice: 210, mrp: 225, stock: 8, minStock: 15, unit: 'Kg', gstPercent: 0, supplier: 'sup1', isActive: true, createdAt: '2024-01-01' },
  { id: 'p3', name: 'Amul Butter 500g', sku: 'DAIRY001', barcode: '8901234567892', category: 'Dairy', brand: 'Amul', purchasePrice: 240, sellingPrice: 275, mrp: 290, stock: 3, minStock: 10, unit: 'Piece', gstPercent: 12, supplier: 'sup2', expiryDate: '2025-02-15', isActive: true, createdAt: '2024-01-01' },
  { id: 'p4', name: 'Dettol Soap 125g', sku: 'HYG001', barcode: '8901234567893', category: 'Hygiene', brand: 'Dettol', purchasePrice: 38, sellingPrice: 48, mrp: 55, stock: 60, minStock: 20, unit: 'Piece', gstPercent: 18, supplier: 'sup3', isActive: true, createdAt: '2024-01-01' },
  { id: 'p5', name: 'Paracetamol 500mg', sku: 'MED001', barcode: '8901234567894', category: 'Medicine', brand: 'Cipla', purchasePrice: 12, sellingPrice: 18, mrp: 22, stock: 150, minStock: 50, unit: 'Strip', gstPercent: 5, supplier: 'sup4', expiryDate: '2025-03-31', batchNumber: 'B2024-001', isActive: true, createdAt: '2024-01-01' },
  { id: 'p6', name: 'Fortune Sunflower Oil 1L', sku: 'GRO003', barcode: '8901234567895', category: 'Grocery', brand: 'Fortune', purchasePrice: 142, sellingPrice: 165, mrp: 175, stock: 25, minStock: 10, unit: 'Litre', gstPercent: 5, supplier: 'sup1', isActive: true, createdAt: '2024-01-01' },
  { id: 'p7', name: 'Maggi Noodles 70g', sku: 'GRO004', barcode: '8901234567896', category: 'Grocery', brand: 'Nestlé', purchasePrice: 12, sellingPrice: 15, mrp: 16, stock: 5, minStock: 30, unit: 'Piece', gstPercent: 12, supplier: 'sup1', isActive: true, createdAt: '2024-01-01' },
  { id: 'p8', name: 'Colgate MaxFresh 200g', sku: 'HYG002', barcode: '8901234567897', category: 'Hygiene', brand: 'Colgate', purchasePrice: 78, sellingPrice: 98, mrp: 110, stock: 35, minStock: 15, unit: 'Piece', gstPercent: 18, supplier: 'sup3', isActive: true, createdAt: '2024-01-01' },
  { id: 'p9', name: 'Amoxicillin 250mg', sku: 'MED002', barcode: '8901234567898', category: 'Medicine', brand: 'Sun Pharma', purchasePrice: 45, sellingPrice: 65, mrp: 78, stock: 80, minStock: 30, unit: 'Strip', gstPercent: 12, supplier: 'sup4', expiryDate: '2025-01-20', batchNumber: 'B2024-002', isActive: true, createdAt: '2024-01-01' },
  { id: 'p10', name: 'Surf Excel 1kg', sku: 'HYG003', barcode: '8901234567899', category: 'Cleaning', brand: 'HUL', purchasePrice: 175, sellingPrice: 210, mrp: 230, stock: 20, minStock: 10, unit: 'Kg', gstPercent: 18, supplier: 'sup3', isActive: true, createdAt: '2024-01-01' },
  { id: 'p11', name: 'Bourn Vita 1kg', sku: 'BEV001', barcode: '8901234567900', category: 'Beverages', brand: 'Cadbury', purchasePrice: 320, sellingPrice: 375, mrp: 410, stock: 12, minStock: 8, unit: 'Piece', gstPercent: 18, isActive: true, createdAt: '2024-01-01' },
  { id: 'p12', name: 'Pantene Shampoo 180ml', sku: 'HAIR001', barcode: '8901234567901', category: 'Personal Care', brand: 'P&G', purchasePrice: 128, sellingPrice: 155, mrp: 175, stock: 22, minStock: 10, unit: 'Piece', gstPercent: 18, isActive: true, createdAt: '2024-01-01' },
];
